...
/* ---- Marketing/contact icons (inline, no web-font dependency) ---- */

/**
 * The brand mark: sun over water. One wave rather than three — the mark is drawn
 * at ~18px in the header, where a second and third crest close up into a smudge.
 * The crest geometry is the one IconWaves uses, so the two read as one family.
 */
export function IconSunSea(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
...
export function IconSparkles(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <path d="M9 3l1.6 4.4L15 9l-4.4 1.6L9 15l-1.6-4.4L3 9l4.4-1.6L9 3Z" />
