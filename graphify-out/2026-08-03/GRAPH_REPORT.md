...
## Corpus Check
- 268 files · ~96,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2376 nodes · 5749 edges · 119 communities (83 shown, 36 thin omitted)
...
## Communities (119 total, 36 thin omitted)
...
Cohesion: 0.05
Nodes (64): AdminAssignment, AdminUser, ApplyBookingMealTimeResult, BookingGroupPage, BookingMealTime, BookingScheduleDay, Closure, ClosureInput (+56 more)
...
Cohesion: 0.07
Nodes (39): TasksController, CancellationToken, Guid, HttpDelete, HttpGet, HttpPost, IActionResult, ProducesResponseType (+31 more)
...
Cohesion: 0.06
Nodes (34): AbstractValidator, MealTimesController, CancellationToken, Guid, HttpDelete, HttpGet, HttpPost, HttpPut (+26 more)
...
Cohesion: 0.12
Nodes (25): bookingGroupCategories, BookingSchedule, checkScheduleConflicts(), createScheduleEntry(), Dashboard, deleteScheduleEntry(), getBookingSchedule(), getDashboard() (+17 more)
...
Cohesion: 0.12
Nodes (10): CampCenter.Infrastructure.Persistence.Configurations, IEntityTypeConfiguration, AdminUserConfiguration, EntityTypeBuilder, BookingConfiguration, EntityTypeBuilder, BookingMealTimeConfiguration, EntityTypeBuilder (+2 more)
...
- **Why does `Booking` connect `Integration Test Harness (1)` to `DTOs / Schedule (1)`, `components / admin`, `Room Task Management (1)`, `CampCenter.UnitTests / Services (2)`, `@types/react`, `CampCenter.Infrastructure / Repositories (1)`, `CampCenter.Application / Services (2)`, `Admin Booking & Notifications (1)`, `Payment`, `CampCenter.Domain / Repositories (1)`, `Integration Test Harness (2)`, `Admin Booking & Notifications (4)`, `Public Booking Service (1)`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `CampCenter.Domain.Entities` connect `Public Booking Service (2)` to `Room Management`, `Admin Bookings Controller & DTOs`, `CampCenter.UnitTests / Validators`, `Room Task Management (1)`, `CampCenter.Application / Services (2)`, `CampCenter.UnitTests / Services (1)`, `Integration Test Harness (1)`, `Camp Session Management`, `Booking Persistence & Entities (1)`, `Application Namespaces & DTOs`, `components / admin`, `Validator Unit Tests`, `CampCenter.UnitTests / Services (2)`, `Refresh Token Repository`, `Exception`, `RoomNumberComparer`, `.CreateClient`, `WriteRequiresAdministratorHandler`, `CampCenter.Application.DTOs.Public`, `UserValidators.cs`, `@types/react`, `Payment`?**
