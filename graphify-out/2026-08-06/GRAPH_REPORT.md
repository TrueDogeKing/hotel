...
## Corpus Check
- 271 files · ~97,489 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2393 nodes · 5796 edges · 136 communities (90 shown, 46 thin omitted)
...
Cohesion: 0.25
Nodes (3): CampCenter.Infrastructure.Auth, CampCenter.Api.Controllers, BcryptPasswordHasher
...
Cohesion: 0.18
Nodes (9): DeleteBookingMealsResultDto, DeleteMealTimeDefaultResultDto, NeighbourSittingDto, SetBookingMealTimeRequestDto, UpdateMealTimeDefaultRequestDto, MealTimeRules, SetBookingMealTimeRequestValidator, UpdateMealTimeDefaultRequestValidator (+1 more)
...
Cohesion: 0.16
Nodes (9): CampCenter.IntegrationTests, CampCenter.Api.RateLimiting, CampCenter.Application.DTOs.Rooms, CampCenter.Api.Controllers.Public, CampCenter.Application.DTOs.Public, CampCenter.Application.DTOs.Closures, PublicPaymentsController, RateLimitPolicies (+1 more)
...
### Community 78 - "MealTimeValidatorsTests"
Cohesion: 0.33
Nodes (3): CreateMealTimeDefaultRequestDto, CreateMealTimeDefaultRequestValidator, MealTimeValidatorsTests
...
- **Why does `CampCenter.Application.Interfaces` connect `Application Namespaces & DTOs` to `Room Management`, `ClosureService`, `Payment`, `Payment Gateway Integration Tests (1)`, `Auth Service & Tokens`, `SmtpEmailSender`, `CampCenter.Application.DTOs.Public`, `Auth Controller (1)`, `Password Hashing (bcrypt)`, `Admin Booking & Notifications (2)`, `Exception`, `Admin Booking & Notifications (4)`, `.CreateClient`, `Public Booking Service (2)`?**
