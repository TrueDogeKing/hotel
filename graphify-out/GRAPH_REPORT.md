...
## Corpus Check
- 297 files · ~114,161 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2573 nodes · 6281 edges · 138 communities (95 shown, 43 thin omitted)
...
Cohesion: 0.07
Nodes (13): CampCenter.Application.Validators, CampCenter.UnitTests.Validators, MealTimeRules, string, PasswordRules, int, IRuleBuilder, IRuleBuilderOptions (+5 more)
...
Cohesion: 0.12
Nodes (23): ScheduleEntry, ScheduleEntryKind, DateOnly, DateTime, Guid, TimeOnly, ScheduleEntryConfiguration, EntityTypeBuilder (+15 more)
...
Cohesion: 0.08
Nodes (31): formatZl(), Availability, AvailabilityCalendar, AvailabilityDay, BookingDetails, BookingPayment, cancelBooking(), createBooking() (+23 more)
...
Cohesion: 0.09
Nodes (33): createMealTime(), deleteMealTime(), getMealTimes(), MealKind, mealKinds, MealTimeDefault, ScheduleDay, ScheduleEntry (+25 more)

### Community 19 - "src / utils"
Cohesion: 0.16
Nodes (28): getAvailabilityCalendar(), CalendarTile(), Props, DayCalendar(), Props, groupHue(), LaneEvent, packLanes() (+20 more)

### Community 20 - "Integration Test Harness (1)"
Cohesion: 0.11
Nodes (18): HousekeepingJob, HousekeepingPlanner, DateOnly, IEnumerable, List, Booking, BookingCancelReason, BookingPaymentState (+10 more)
...
Cohesion: 0.06
Nodes (35): AbstractValidator, MealTimesController, CancellationToken, Guid, HttpDelete, HttpGet, HttpPost, HttpPut (+27 more)
...
Cohesion: 0.09
Nodes (30): PublicBookingsController, CancellationToken, EnableRateLimiting, HttpGet, HttpPost, IActionResult, IValidator, ProducesResponseType (+22 more)
...
Cohesion: 0.06
Nodes (43): ClosuresController, CancellationToken, Guid, HttpDelete, HttpGet, HttpPost, HttpPut, IActionResult (+35 more)
...
Cohesion: 0.18
Nodes (13): BookingGroupCategory, BookingStatus, DashboardBooking, getBookingGroupPage(), BookingGroupSection(), Props, DateField(), Props (+5 more)
...
Cohesion: 0.10
Nodes (30): bookingGroupCategories, BookingSchedule, checkScheduleConflicts(), createScheduleEntry(), Dashboard, deleteScheduleEntry(), getBookingSchedule(), getDashboard() (+22 more)
...
Cohesion: 0.08
Nodes (33): AdminBooking, AssignableRoom, BookingState, bookingStates, bookingStatuses, createAdminBooking(), getAdminBooking(), getAdminBookings() (+25 more)
...
Cohesion: 0.11
Nodes (17): AdminAssignmentDto, AssignableRoomDto, BookingGroupPageDto, CreateAdminBookingRequestDto, CreateRoomTaskRequestDto, DashboardBookingDto, DashboardDto, OccupancyDto (+9 more)

### Community 62 - "RoomCleaningRepository"
Cohesion: 0.22
Nodes (5): Migration, ScheduleAndMealTimes, MigrationBuilder, MakeRoomTaskRoomOptional, MigrationBuilder
...
Cohesion: 0.16
Nodes (12): BookingMealTime, DateTime, Guid, TimeOnly, BookingMealTimeConfiguration, EntityTypeBuilder, BookingMealTimeRepository, CancellationToken (+4 more)
...
Cohesion: 0.14
Nodes (8): CampCenter.Application.DTOs.Auth, InlineData, LoginRequestDto, LoginResponseDto, LoginRequestValidator, LoginRequestValidatorTests, Fact, Theory

### Community 99 - "MealTimeDefault"
Cohesion: 0.24
Nodes (9): InitiatePaymentRequestDto, InitiatePaymentResponseDto, IPaymentService, CancellationToken, Task, PaymentService, CancellationToken, ILogger (+1 more)
...
Cohesion: 0.12
Nodes (10): CampCenter.Infrastructure.Persistence.Configurations, IEntityTypeConfiguration, BookingConfiguration, EntityTypeBuilder, BookingRoomAssignmentConfiguration, EntityTypeBuilder, PaymentConfiguration, EntityTypeBuilder (+2 more)
...
- **Why does `CampCenter.Domain.Entities` connect `Exception` to `Room Management`, `CampCenter.UnitTests / Validators`, `Room Task Management (1)`, `CampCenter.Infrastructure / Repositories (1)`, `CampCenter.UnitTests / Services (1)`, `Integration Test Harness (1)`, `Booking Persistence & Entities (1)`, `Application Namespaces & DTOs`, `Admin Booking & Notifications (2)`, `Public Booking Service (2)`, `ClosureService`, `Validator Unit Tests`, `CampCenter.UnitTests / Services (2)`, `CampCenter.UnitTests / Services (3)`, `.Update`, `Refresh Token Repository`, `RoomNumberComparer`, `WriteRequiresAdministratorHandler`, `GroupRooms.tsx`, `CampCenter.Application.DTOs.Public`, `CampCenter.Domain.Exceptions`, `BookingStatus`, `BookingConfiguration`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `CampCenter.Application.Interfaces` connect `Application Namespaces & DTOs` to `ClosureService`, `MealTimeDefault`, `Payment Gateway Integration Tests (1)`, `SmtpEmailSender`, `CampCenter.Application.DTOs.Public`, `ClosureService`, `Exception`, `Persistence / Migrations (2)`, `Public Booking Service (2)`, `Admin Booking & Notifications (4)`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `CampCenter.Infrastructure.Persistence` connect `Exception` to `UsersPage.tsx`, `20260728105506_PerGroupMealTimes.Designer.cs`, `20260719143540_CoreDomain.Designer.cs`, `20260721111400_ReplaceSessionsWithClosures.Designer.cs`, `Persistence / Migrations (9)`, `EF Core Migrations (1)`, `20260802130913_MakeRoomTaskRoomOptional.Designer.cs`, `Persistence / Migrations (13)`, `IClosureRepository`, `EF Core Migrations (3)`, `AppDbContext`, `20260730211855_AdminUserRole.Designer.cs`, `GroupRooms.tsx`, `Public Booking Service (2)`?**
...
- **Should `CampCenter.UnitTests / Validators` be split into smaller, more focused modules?**
