...
```dataview
TABLE source_file, type FROM #community/AdminBookingDto
SORT file.name ASC
```

## Connections to other communities
- 13 edges to [[_COMMUNITY_Admin Booking & Notifications (2)]]
- 12 edges to [[_COMMUNITY_.Update]]
- 12 edges to [[_COMMUNITY_Admin Bookings Controller & DTOs]]
- 6 edges to [[_COMMUNITY_.Groups]]
