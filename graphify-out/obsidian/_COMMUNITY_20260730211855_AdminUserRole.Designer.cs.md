...
```dataview
TABLE source_file, type FROM #community/20260730211855_AdminUserRoleDesignercs
SORT file.name ASC
```
...
## Top bridge nodes
- [[20260730211855_AdminUserRole.Designer.cs]] - degree 3, connects to 2 communities