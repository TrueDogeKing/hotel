...
```dataview
TABLE source_file, type FROM #community/CampCenterApplicationDTOsPublic
SORT file.name ASC
```
...
## Top bridge nodes
- [[CampCenter.Application.DTOs.Closures]] - degree 8, connects to 5 communities
- [[CampCenter.Application.DTOs.Public]] - degree 14, connects to 4 communities
- [[CampCenter.Application.DTOs.Rooms]] - degree 12, connects to 4 communities
- [[CampCenter.IntegrationTests]] - degree 11, connects to 4 communities
