...
- [[Task]] - code
- [[WriteRequiresAdministrator.cs]] - code - src/CampCenter.Api/Auth/WriteRequiresAdministrator.cs
- [[WriteRequiresAdministratorHandler]] - code - src/CampCenter.Api/Auth/WriteRequiresAdministrator.cs
- [[WriteRequiresAdministratorRequirement]] - code - src/CampCenter.Api/Auth/WriteRequiresAdministrator.cs
- [[string]] - code

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/WriteRequiresAdministratorHandler
SORT file.name ASC
```
