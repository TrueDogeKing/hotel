...
```dataview
TABLE source_file, type FROM #community/Room_Closure_Management
SORT file.name ASC
```

## Connections to other communities
- 26 edges to [[_COMMUNITY_Domain & Infra Namespaces]]
- 21 edges to [[_COMMUNITY_src  utils]]
- 18 edges to [[_COMMUNITY_src  api (1)]]
- 18 edges to [[_COMMUNITY_Persistence  Migrations (10)]]
- 16 edges to [[_COMMUNITY_useAuth]]
- 15 edges to [[_COMMUNITY_MealTimeDefault]]
...
## Top bridge nodes
- [[admin.ts]] - degree 135, connects to 8 communities
- [[ClosuresPage.tsx]] - degree 19, connects to 3 communities
- [[RoomsPage.tsx]] - degree 15, connects to 3 communities
- [[HousekeepingPage.tsx]] - degree 19, connects to 2 communities
- [[OccupancyPage.tsx]] - degree 16, connects to 2 communities