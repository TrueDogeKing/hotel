...
- [[vite_1]] - concept - frontend/package.json

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/ESLint_Dev_Dependencies
SORT file.name ASC
```
...
- 1 edge to [[_COMMUNITY_@vitejsplugin-react]]

## Top bridge nodes
- [[devDependencies]] - degree 14, connects to 6 communities