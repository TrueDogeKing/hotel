...
# campcenter-caddy (reverse proxy / TLS)
...
## Connections
- [[CampCenter Project Instructions]] - `conceptually_related_to` [INFERRED]
- [[Production Docker Compose Stack]] - `references` [EXTRACTED]
- [[campcenter-api (prod service)]] - `references` [EXTRACTED]
