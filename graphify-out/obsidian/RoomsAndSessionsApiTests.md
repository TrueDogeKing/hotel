---
source_file: "tests/CampCenter.IntegrationTests/RoomsAndSessionsApiTests.cs"
type: "code"
...
# RoomsAndSessionsApiTests

## Context

_Source: `tests/CampCenter.IntegrationTests/RoomsAndSessionsApiTests.cs` — full file embedded (123 lines)._ ⚠️ **This file is deleted in the current working tree** (uncommitted change); context below is the committed version from git HEAD.
...
## Connections
- [[.AdminEndpoints_WithoutToken_ReturnUnauthorized()]] - `method` [EXTRACTED]
- [[.Rooms_CrudRoundtrip_Works()]] - `method` [EXTRACTED]
- [[.Sessions_LifecycleAndOverlapGuard_Work()]] - `method` [EXTRACTED]
- [[IntegrationTestBase]] - `inherits` [EXTRACTED]
- [[RoomsAndSessionsApiTests.cs]] - `contains` [EXTRACTED]
