...
_Source: `src/CampCenter.Api/OpenApi/BearerSecuritySchemeTransformer.cs` (defined near L1; showing L1–L42 of 42)._
...
## Connections
- [[BearerSecuritySchemeTransformer]] - `contains` [EXTRACTED]
- [[CampCenter.Api.OpenApi]] - `contains` [EXTRACTED]
