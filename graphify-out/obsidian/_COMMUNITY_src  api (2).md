...
```dataview
TABLE source_file, type FROM #community/src_/_api_2
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_RoomCleaningRepository]]
...
- [[SetBookingMealTimeRequestDto]] - degree 5, connects to 3 communities
- [[MealTimesController]] - degree 8, connects to 2 communities
- [[IMealTimeService]] - degree 7, connects to 2 communities
- [[CreateMealTimeDefaultRequestDto]] - degree 6, connects to 2 communities