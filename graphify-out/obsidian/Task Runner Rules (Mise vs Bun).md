...
## Connections
- [[Bun (application task runner  frontend package manager)]] - `references` [EXTRACTED]
- [[Mise (infrastructure task runner)]] - `references` [EXTRACTED]
