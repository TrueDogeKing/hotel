...
- [[IconMapPin()]] - code - frontend/src/components/icons.tsx
...
```dataview
TABLE source_file, type FROM #community/Frontend_Icon_Components
SORT file.name ASC
```

## Connections to other communities
- 12 edges to [[_COMMUNITY_Public Booking Frontend (1)]]
