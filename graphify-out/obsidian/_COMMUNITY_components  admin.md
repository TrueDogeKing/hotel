...
```dataview
TABLE source_file, type FROM #community/components_/_admin
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_CampCenter.Domain  Repositories (1)]]
...
## Top bridge nodes
- [[AppDbContext]] - degree 28, connects to 12 communities
- [[BookingRoomAssignment]] - degree 15, connects to 6 communities
