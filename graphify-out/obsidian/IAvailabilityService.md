...
_Source: `src/CampCenter.Application/Interfaces/IAvailabilityService.cs` (defined near L5; showing L3–L43 of 43)._
...
- [[.GetPublicSessionsAsync()]] - `method` [EXTRACTED]
- [[AvailabilityService]] - `implements` [EXTRACTED]
- [[BookingService]] - `references` [EXTRACTED]
- [[IAvailabilityService.cs]] - `contains` [EXTRACTED]
- [[PublicSessionsController]] - `references` [EXTRACTED]
