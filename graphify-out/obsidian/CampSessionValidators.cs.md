...
- [[CampSessionRules]] - `contains` [EXTRACTED]
- [[CreateCampSessionRequestValidator]] - `contains` [EXTRACTED]
- [[UpdateCampSessionRequestValidator]] - `contains` [EXTRACTED]
